package com.example.umc.study.ApiResponse.code.status;

import com.example.umc.study.ApiResponse.code.BaseErrorCode;
import com.example.umc.study.ApiResponse.code.ErrorReasonDTO;
...
public enum ErrorStatus implements BaseErrorCode {
    ...
    // page 관련 에러
    INVALID_PAGE(HttpStatus.BAD_REQUEST,"PAGE4001","페이지는 1 이상이여야 합니다."),
    // 예시,,,
