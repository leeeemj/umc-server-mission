...
public class QMemberPrefer extends EntityPathBase<MemberPrefer> {
    ...
    private static final long serialVersionUID = -570276037L;
    ...
    public final com.example.umc.study.domain.QFoodCategory foodCategory;
    ...
    public QMemberPrefer(Class<? extends MemberPrefer> type, PathMetadata metadata, PathInits inits) {
        ...
        this.foodCategory = inits.isInitialized("foodCategory") ? new com.example.umc.study.domain.QFoodCategory(forProperty("foodCategory")) : null;
